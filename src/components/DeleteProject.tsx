...
export function DeleteProject(props: { name: string }) {
  ...
  return (
    <div>
      <Button
        className='mx-auto mt-5 bg-red-300 bg-opacity-20 hover:bg-red-300 hover:bg-opacity-30'
        onClick={() => setShow(true)}
      >
        <TrashIcon className='mr-3 w-4 text-red-500' />
        <span className='text-sm font-semibold text-red-500'>Xóa dự án</span>
      </Button>
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            <h3 className='mb-5 text-lg font-normal text-gray-500 dark:text-gray-400'>
              Bạn có chắc chắn muốn xóa dự án {props.name}?
            </h3>
